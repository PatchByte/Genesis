...
namespace genesis::renderer
{
    ...
    VkPhysicalDevice GenesisVulkanImplementation::SetupVulkan_SelectPhysicalDevice()
    {
        uint32_t gpu_count;
    ...
    void GenesisVulkanImplementation::SetupVulkan(std::vector<const char*> instance_extensions)
    {
        VkResult err;
    ...
    void GenesisVulkanImplementation::SetupVulkanWindow(ImGui_ImplVulkanH_Window* wd, VkSurfaceKHR surface, int width, int height)
    {
        wd->Surface = surface;
    ...
    void GenesisVulkanImplementation::CleanupVulkan()
    {
    ...
    void GenesisVulkanImplementation::FrameRender(ImGui_ImplVulkanH_Window* wd, ImDrawData* draw_data)
    {
        VkResult err;
    ...
    void GenesisVulkanImplementation::FramePresent(ImGui_ImplVulkanH_Window* wd)
    {
    ...
    void GenesisVulkanImplementation::CleanupVulkanWindow()
    {
    ...
    GenesisVulkanImplementation::~GenesisVulkanImplementation()
    {
        if (m_Running)
            Shutdown();
    }

    bool GenesisVulkanImplementation::Initialize()
    {
        ...
        {
            printf("[GenesisVulkanImplementation::Initialize] glfwVulkanSupported() returned false!\n");
            return false;
        }
    ...
    bool GenesisVulkanImplementation::Shutdown()
    {
    ...
    bool GenesisVulkanImplementation::BeginFrame()
    {
    ...
    bool GenesisVulkanImplementation::EndFrame()
    {
        ImGui::Render();
    ...
    bool GenesisVulkanImplementation::ShallRender()
    {
